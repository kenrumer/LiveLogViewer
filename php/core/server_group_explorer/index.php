...
?>
    ...
    <div class="folder_panel server_group context_menu" id="server_group_context_menu">
      <a class="context_menu indent" href="#" onclick="context_menu_item_click('server_group_explorer_open_item');" title="Show Details"><b>Show Details</b></a>
      <a class="context_menu indent" href="#" onclick="context_menu_item_click('server_group_explorer_expand_item');" title="Expand this item">Expand</a>
      <a class="context_menu indent" href="#" onclick="context_menu_item_click('server_group_explorer_explore_from_here');" title="Explore from here">Explore from here</a>
    ...
    <div class="folder_panel server context_menu" id="server_context_menu">
      ...
      <a class="context_menu indent" href="#" onclick="context_menu_item_click('server_group_explorer_explore_from_here');" title="Explore from here">Explore from here</a>
      <div class="context_menu horizontal_rule"></div>
      <a class="context_menu indent" href="#" onclick="context_menu_item_click('server_group_explorer_take_thread_dump');" title="Take thread dump">Take thread dump</a>
      <a class="context_menu indent" href="#" onclick="context_menu_item_click('server_group_explorer_list_processes');" title="List processes running on the server">List Processes</a>
      <div class="context_menu horizontal_rule"></div>
      <a class="context_menu" href="#" onclick="history.go(0);" title="Refresh the contents of this page"><img class="context_menu icon" src="/common/images/refreshico.png" alt="Refresh" />Refresh</a>
    ...
    <div class="folder_panel directory context_menu" id="directory_context_menu">
      <a class="context_menu indent" href="#" onclick="context_menu_item_click('server_group_explorer_open_item');" title="Show Details"><b>Show Details</b></a>
      <a class="context_menu indent" href="#" onclick="context_menu_item_click('server_group_explorer_expand_item');" title="Expand this item">Expand</a>
      <a class="context_menu indent" href="#" onclick="context_menu_item_click('server_group_explorer_explore_item');" title="Make this item the root">Explore From Here</a>
      <a class="context_menu indent" href="#" onclick="context_menu_item_click('compare_items_add_item');" title="Compare this directory">Compare Directory</a>
      <div class="context_menu horizontal_rule"></div>
    ...
    <div class="folder_panel file context_menu" id="file_context_menu">
      <a class="context_menu indent" href="#" onclick="context_menu_item_click('server_group_explorer_open_item');" title="Open File"><b>Open File</b></a>
      <a class="context_menu indent" href="#" onclick="context_menu_item_click('server_group_explorer_tail_file');" title="Tail this file">Tail File</a>
