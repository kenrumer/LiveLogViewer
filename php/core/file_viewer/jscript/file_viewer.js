  ...
  function file_viewer_tail_init () {
    ...
    g_old_content = document.getElementById('content').innerHTML;
      ...
      if (xmlhttp.status == 200) {
        ...
        if (response) {
          ...
          if (response.getElementsByTagName("file_text")[0].firstChild) {
            ...
            document.getElementById('content').innerHTML="<pre>"+g_old_content+"</pre>";
  ...
  function file_viewer_save_as () {
    ...
    switch (document.getElementById('doc_version').value) {
      ...
      case 'crispy':
        strFileData = document.getElementById('content').innerHTML;
        strFileData.substr(5, strFileData.length - 11);
        break;
    }
    document.getElementById('filedata').value = strFileData;
