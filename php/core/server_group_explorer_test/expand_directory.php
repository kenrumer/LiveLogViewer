<?php
  ...
  if (isset($_SERVER['HTTPS'])) {
    ...
    @require ("http://".urlencode($session->get("user_name", "node_php")).":".urlencode($session->get("passwd", "node_php"))."@".$frontend_server."/".$server['fqdn']."/get_directory_contents.php?paths=".urlencode($path));
  }
...
?>
          <a class="folder_panel" href="#" onclick="server_group_explorer_open_item(this.parentNode);" id="<?php echo($path_id); ?>href2" oncontextmenu="return context_menu_show_context_menu(this.parentNode);"><img class="folder_panel blue_steel directory icon" src="/common/images/directoryico.png" id="<?php echo($path_id); ?>image"></a>
          <a class="folder_panel directory text" href="#" onclick="server_group_explorer_open_item(this.parentNode);" id="<?php echo($path_id); ?>href3" oncontextmenu="return context_menu_show_context_menu(this.parentNode);"><?php echo($content); ?></a>
        </div>
<?php
...
?>
        <div style="text-indent: <?php echo($icon_indent); ?>pt" id="<?php echo($path_id); ?>" item_type="file" item_id="<?php echo($id); ?>" item_path="<?php echo($subpath); ?>" item_path_id="<?php echo($path_id); ?>" item_tail="false">
          <a class="folder_panel" href="#" onclick="server_group_explorer_open_item(this.parentNode);" id="<?php echo($path_id); ?>href2" oncontextmenu="return context_menu_show_context_menu(this.parentNode);"><img class="folder_panel blue_steel file icon" src="/common/images/fileico.png" id="<?php echo($path_id); ?>image"></a>
          <a class="folder_panel file text" href="#" onclick="server_group_explorer_open_item(this.parentNode);" id="<?php echo($path_id); ?>href3" oncontextmenu="return context_menu_show_context_menu(this.parentNode);"><?php echo($content); ?></a>
        </div>
<?php
