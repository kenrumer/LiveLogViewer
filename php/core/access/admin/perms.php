  ...
  if (isset($_POST['action']))
  {
    switch($_POST['action']) {
      case 'savePerm':
        ...
        break;
      case 'delPerm':
        $strSQL = sprintf("DELETE FROM access.permission WHERE idpermission = %u LIMIT 1",$_POST['permID']);
        pg_query($strSQL);
        break;
    }
...
?>
    	<h2>Manage Permission: (<?php echo ($myACL->getPermNameFromID($_GET['permID'])); ?>)</h2>
<?php
