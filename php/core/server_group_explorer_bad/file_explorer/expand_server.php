...
?>
        <div style="text-indent: <?php echo($icon_indent); ?>pt" id="<?php echo($path_id); ?>" item_type="file" item_id="<?php echo($id); ?>" item_path="<?php echo($path['name']); ?>" item_path_id="<?php echo($path_id); ?>" item_indent="<?php echo($indent); ?>" item_tail="false">
          <a class="folder_panel" href="#" onclick="file_explorer_open_item(this.parentNode);" id="<?php echo($path_id); ?>href2" onContextMenu="return context_menu_show_context_menu(this.parentNode);"><img class="folder_panel icon" src="/common/images/fileico.png" id="<?php echo($path_id); ?>image"></a>
          <a class="folder_panel file text" href="#" onclick="file_explorer_open_item(this.parentNode);" id="<?php echo($path_id); ?>href3" onContextMenu="return context_menu_show_context_menu(this.parentNode);"><?php echo($path['name']); ?></a>
        </div>
<?php
