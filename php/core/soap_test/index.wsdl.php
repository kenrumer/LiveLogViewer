<?php
  ...
  $wsdl = "http://ddmcore01.prod.idc1.level3.com:8080/axis2/services/UcmdbService?wsdl";
  $username = "rumer.ken";
  $password = "G9lf4U&I";
  $client = new SoapClient($wsdl, array('trace' => 1, 'login' => $username, 'password' => $password));

  $password=urlencode("L3hpoo!");
  echo(passthru("http://hpoo:".$password."@ddmcore01.prod.idc1.level3.com:8080/axis2/services/UcmdbService?wsdl"));
  exit (0);
