<?php
  ...
  $path = $database->get_item("path", $path_id);
    ...
    <div class="common panel blue_steel path_administration">
      ...
      <div class="common content blue_steel with_title">
        <div class="path_administration outer_panel">
          ...
          <div class="path_administration path"><input type="text" class="path_administration path" id="name" name="name" value="<?php echo ($path['name']); ?>" /></div>
<?php
...
?>
          <div class="path_administration is_root"><input type="checkbox" class="path_administration is_root" id="is_root" name="is_root" /></div>
<?php
...
?>
          <div class="path_administration is_directory"><input type="checkbox" class="path_administration is_directory" id="is_directory" name="is_directory" /></div>
<?php
...
?>
          ...
          <div class="path_administration ok_button"><input class="path_administration ok_button" type="button" value="OK" onclick="path_administration_update_path(<?php echo ($path_id); ?>);"></div>
