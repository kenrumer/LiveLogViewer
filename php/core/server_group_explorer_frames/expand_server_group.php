...
?>
        <div style="text-indent: <?php echo($plus_indent); ?>pt" id="<?php echo($server_group_id); ?>" expanded="false" item_type="server_group" item_id="<?php echo($server_group['id']); ?>" item_indent="<?php echo($indent); ?>">
...
?>
        <div style="text-indent: <?php echo($plus_indent); ?>pt" id="<?php echo($server_id); ?>" expanded="false" item_type="server" item_id="<?php echo($server['id']); ?>" item_indent="<?php echo($indent); ?>">
